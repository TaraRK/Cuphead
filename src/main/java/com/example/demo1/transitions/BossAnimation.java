...
public class BossAnimation extends Transition {
	...
	private static int framesCount = 6;
	static {
		frames = new Vector<>();
		for(int i = 1; i <= framesCount; i++)
			frames.add(new ImagePattern(new Image(BossAnimation.class.getResource("/com/example/demo1/PNG/boss/normal/" + i + ".png").toExternalForm())));
	}

	private BossComponent component;
	public BossAnimation(BossComponent component){
